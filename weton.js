...
function weton(x){
    ...
    var padu = [6, 15, 24, 33,'PADU','"Hasil Padu, menurut hitungan weton jawa digambarkan dalam berumah tangganya nanti akan sering mengalami sebuah pertengkaran. Namun tidak sampai mengarah ke sebuah perceraian. Masalah pertengkaran ini digambarkan hanya masalah yang sifatnya cukup sepele."']
...
<i class='separate'></i>    
  ...
  <div class='promo'>Jadi <i>Neptu</i> kamu : <mark style="background-color: red">  <b>`+layla[3]+`</b></mark> dan neptu pasanganmu : <mark style="background-color: red"><b>`+majnun[3]+`</b></mark> <i>Wetonnya</i>   <mark style="background-color: red"><b>`+total+`</b></mark></div>    
                       
<center><div class='note noteAlert'><font color='red'><h4>`+final[0]+`  (`+total+`) </h4></font></div></center>
<div class='note'>
`+final[1]+`
