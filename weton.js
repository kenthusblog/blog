...
<i class='separate'></i>    
  ...
  <blockquote class='style-3'>Jadi <i>Neptu</i>  <b>`+layla[3]+`</b> dan <b>`+majnun[3]+`</b> <i>Wetonnya</i>  <b>`+total+`</b></blockquote>    
...
<div class='block-author'>
    <div class='block-img'>
      <img class='lazy' alt='Author' data-src='https://1.bp.blogspot.com/-dJwo8gKT33s/YAh3hEqxMVI/AAAAAAAAHuQ/lYL5jySX9hworxSbHVsMxCYf5q-mDcrfwCLcBGAsYHQ/s0/blangkon.png' src='data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs='/>
    </div>
    <div class='block-info'><span class='block-name'></span><span class='block-desc'>dikutip dari berbagai sumber<br></span>
    </div>
  </div>
</blockquote>
                </div></div>
